    ...
    <header className="fixed top-0 left-0 right-0 z-50 border-b border-passport-border bg-passport-bg/92 backdrop-blur-xl">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 h-14 flex items-center justify-between">
        ...
        <nav className="hidden sm:flex items-center gap-1">
          <Link href="/" className="px-3 py-1.5 text-sm text-passport-muted hover:text-passport-text rounded-passport hover:bg-passport-surface transition-colors duration-150">
            Home
          </Link>
          <Link href="/login" className="px-3 py-1.5 text-sm text-passport-muted hover:text-passport-text rounded-passport hover:bg-passport-surface transition-colors duration-150">
            Sign In
          </Link>
