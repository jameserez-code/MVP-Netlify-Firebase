      ...
      >
        ...
        <div
          style={{
            ...
            inset: 0,
            backgroundImage:
              'linear-gradient(to bottom, rgba(46,160,67,0.06) 1px, transparent 1px), linear-gradient(to right, rgba(46,160,67,0.06) 1px, transparent 1px)',
        ...
        >
          ...
          >
            v2.1.0 — Control what your AI agents can do
          </div>
        </div>
      </div>
    ),
